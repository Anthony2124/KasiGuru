...
window.recategorizeGeneralWords = async function() {
  ...
  const natureWords = ['bamboo', 'bark', 'branch', 'earth', 'forest', 'leaf', 'mountain', 'ocean', 'river', 'sea', 'soil', 'stone', 'tree', 'wave', 'root', 'seed', 'flower', 'grass', 'vine', 'bush', 'thorn', 'wood', 'lake', 'spring', 'waterfall', 'island', 'sand', 'mud', 'clay', 'rock', 'hill', 'valley', 'cave', 'field', 'garden', 'plant', 'grow', 'land', 'shore', 'reef', 'coral'];
